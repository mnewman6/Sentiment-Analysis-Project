...
rading, expecting to make money is more stressful than we think because the stcoks price is affected by severals factors including inside and outside information of the company. Current Stock Price, Dividend Payout are considered as insider information whereas comments and sentiment of people and news article over the internet are outside factors to effect stock price. Here in our model we use there crucial analysis to predict buy and sell signals. 
